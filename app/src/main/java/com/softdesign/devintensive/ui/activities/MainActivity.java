...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setupToolbar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle("Русских Ольга");
        }
    }
    ...
    /**
     * Загрузка фто из галлереи
     */
    private void loadPhotoFromGallery() {
        Intent takeGalleryIntent = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
        takeGalleryIntent.setType("image/*");
        startActivityForResult(Intent.createChooser(takeGalleryIntent, getString(R.string.user_profile_choce_message)), ConstantManager.REQUEST_GALLERY_PICTURE);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == ConstantManager.CAMERA_REQUEST_PERMISSIONS_CODE && grantResults.length == 3) {
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case ConstantManager.LOAD_PROFILE_PHOTO:
                String[] selectItems = {getString(R.string.ser_profile_dialog_gallery),
    ...
    /**
     * Отключение ошибок у TextInputLayout
     */
