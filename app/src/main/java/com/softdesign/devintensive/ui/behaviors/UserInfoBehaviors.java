...
public class UserInfoBehaviors<V extends LinearLayout> extends AppBarLayout.ScrollingViewBehavior {
    ...
    public UserInfoBehaviors(Context context, AttributeSet attrs){
        super(context, attrs);
        ...
        a.recycle();
        mMinAppbarHeight = UiHelper.getStatusAppbarHeight()+UiHelper.getActionBarHeight();
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        int currentHeight = UiHelper.lern(mMinUserInfoHeight, mMaxUserInfoHeight, currentFriction);
